    ...
    var body: some View {
        VStack(spacing: 0) {
            HStack {
                ...
                Text(LocalizedStringKey("EarthquakeDetail"))
                    .font(.title2)
                    .fontWeight(.light)
                Spacer()
            }
            ...
            Map(initialPosition: initialPosition) {
                Marker(LocalizedStringKey("EarthquakeLocation"), coordinate: markerLocation)
